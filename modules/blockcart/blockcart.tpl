...
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			<span class="greenpill"><span class="b">{l s='Cart' mod='blockcart'}</span></span>
			...
			<span class="ajax_cart_no_product{if $cart_qties > 0} unvisible{/if}"><span class="onbig">{l s='(empty)' mod='blockcart'}</span><span class="onmob">0</span></span>
	...
	<div id="layer_cart">
		<div class="clearfix">
			<div class="layer_cart_product col-xs-12 col-md-6">
				...
				<div class="product-image-container layer_cart_img col-sm-6">
				</div>
				<div class="layer_cart_product_info col-sm-6">
