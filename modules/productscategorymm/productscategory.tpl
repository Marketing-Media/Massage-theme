...
{if $page_name !='index' && $page_name !='product'}
	...
	{/if}
{if count($categoryProductsmm) > 0 && $categoryProductsmm !== false}
<section class="page-product-box blockproductscategory">
	<h3 class="productscategory_h3 page-product-heading">
	{if $lang_iso == en}{l s="Products from the same manufacturer"} {else}Produits du même fabricant {/if}
	</h3>
	<div id="productscategory_list" class="clearfix">
		<ul id="productscategory_list3" class="product_list grid row clearfix">
		{foreach from=$categoryProductsmm item='categoryProduct' name=categoryProduct}
