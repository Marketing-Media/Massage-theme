...
{else}
	...
	<section class="footer-block col-xs-12 col-sm-3" id="block_various_links_footer">
		...
		<ul class="toggle-footer">
			...
			{/foreach}
			<li class="item">
						<a href="{$link->getCMSLink(4)}#{if $lang_iso == en}OurStore{else}NotreBoutique{/if}">{if $lang_iso == en}Our Store{else}Notre boutique{/if}</a>
				</li>
			<li class="item">
						<a href="{$link->getCategoryLink(69)}">{if $lang_iso == en}Training workshop{else}Atelier de formation{/if}</a>
				</li>
				<li class="item">
						<a href="{$link->getCMSLink(37)}">{if $lang_iso == en}Rental{else}Location{/if}</a>
				</li>
				
				<li class="item">
						<a href="{if $lang_iso == en}https://massageboutik.com/en/blog/{else}https://massageboutik.com/fr/blogue/{/if}">{if $lang_iso == en}Blog{else}Blogue{/if}</a>
				</li>
