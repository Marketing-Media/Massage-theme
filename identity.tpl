        ...
        <form action="{$link->getPageLink('identity', true)|escape:'html':'UTF-8'}" method="post" class="std">
            <fieldset>
                ...
                <div class="form-group">
                    <label for="my_field"> {l s='Loyalty membership number'} </label>
                    <input id="my_field" class="form-control" name="loyalty" type="text" value="{if isset($smarty.post.loyalty)}{$smarty.post.loyalty}{/if}" />
